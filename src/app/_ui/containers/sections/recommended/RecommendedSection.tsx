...
import { Box, Card, CardActionArea, CardContent, CardMedia, Container, Grid, Rating, Stack, Typography, useTheme } from '@mui/material'
...
export function RecommendedSection() {
  const getLabelText = useCallback((value: number) => ratings[value], [])
